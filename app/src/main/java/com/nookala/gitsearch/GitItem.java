...
public class GitItem implements Parcelable{
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    public static final Creator<GitItem> CREATOR = new Creator<GitItem>() {
        @Override
        public GitItem createFromParcel(Parcel in) {
            return new GitItem(in);
        }
